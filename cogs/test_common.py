...
TEST_NONADMIN_AUTHMOD = "test"
TEST_NONADMIN_USERNAME = "testnonadmin"
TEST_NONADMIN_PASSWORD = "testpassword"
...
NONADMIN_AUTHMOD = os.environ.get('COGS_TEST_NONADMIN_AUTHMOD', TEST_NONADMIN_AUTHMOD)
NONADMIN_USERNAME = os.environ.get('COGS_TEST_NONADMIN_USERNAME', TEST_NONADMIN_USERNAME)
NONADMIN_PASSWORD = os.environ.get('COGS_TEST_NONADMIN_PASSWORD', TEST_NONADMIN_PASSWORD)
